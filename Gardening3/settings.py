"""
Django settings for Gardening3 project.
...
SECRET_KEY = 'django-insecure-u1r!_)jpt-ebq-fd8e*tul84-pswnvkr*c5ae%8oj=-s+6zvn+'
...
WSGI_APPLICATION = 'Gardening3.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'Gardening3/static')
]
